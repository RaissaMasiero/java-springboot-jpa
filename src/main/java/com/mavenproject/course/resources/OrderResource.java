...
import com.mavenproject.course.services.OrderService;
...
public class OrderResource {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<Order> findById(@PathVariable Long id){ // pathvariable: aceita o valor vindo da url
