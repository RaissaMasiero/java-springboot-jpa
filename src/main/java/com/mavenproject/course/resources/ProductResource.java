...
import com.mavenproject.course.services.ProductService;
...
public class ProductResource {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<Product> findById(@PathVariable Long id){ // pathvariable: aceita o valor vindo da url
